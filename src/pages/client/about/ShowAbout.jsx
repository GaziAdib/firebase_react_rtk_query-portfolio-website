    ...
    return (
        <div className='flex flex-col md:flex-row items-center justify-center rounded shadow-lg gap-10 md:gap-20 py-20 bg-gray-800'>
            <div className='w-full md:w-6/12 mx-1 px-1'>
                ...
                <h2 className='text-center text-3xl  text-purple-400 border-2 border-purple-600 text-bold px-1 py-2 my-2 mx-2'>{aboutData?.aboutSubTitle}</h2>
                <p className='text-gray-200  text-md text-left items-center mx-2 px-2  py-1 text-gray-600 mt-4'>Hi I am a Gazi Adib . I like to make apps specially android and I am also pretty well in web design and development . feel free to see code of mine!! share too!</p>
                ...
                <a href="mailto:greatadib82@gmail.com" className='block mt-3 text-md md:text-lg font-bold text-center text-gray-700 underline hover:text-indigo-500'>{aboutData?.aboutLocation}</a>
                <SocialLinks

    ...
    return (
        <div id='hero' className='flex flex-col md:flex-row items-center justify-center rounded shadow-lg gap-10 md:gap-20 py-20 bg-gray-800'>
            <div className='w-full md:w-6/12 mx-1 px-1'>
                ...
                <a href="mailto:greatadib82@gmail.com" className='block mt-3 text-md md:text-lg font-bold text-center text-gray-300 underline hover:text-indigo-500'>greatadib82@gmail.com</a>
